...
`unsigned` types can only represent values greater than or equal to zero. On the other hand, `signed` types can represent negative values, positive values and zero.
...
```
```cpp
1024f  // ERROR: suffix f can be used only with floating-point literals
```
```cpp
...
- is an object;
- hols the address of another object;
...
The fragment of code above computes the square of `i` and stores the result in the same variable.
...
```cpp
int i = 0;
double* dp = &i;    // illegal - types of dp and i differ
...
// evaluates to false if p == nullptr (or 0), otherwise evaluates to true
if (p)

// test the value of the variable to which p points
// false if the value of the pointed object is zero, otherwise true
if (*p) 
```
...
// illegal - p1 and p2 don't have the same low-level const and we can't convert const to nonconst
p1 = p2;

// legal - p1 and p2 don't have the same low-level const BUT WE CAN convert nonconst to const
p2 = p1;

// illegal - p1 and p3 don't have the same low-level const and we can't convert const to nonconst
p1 = p3;
...
- This solution is based on concepts that have not yet been covered in the book;
- [This answer](https://stackoverflow.com/a/24213223) on StackOverflow explains the solution.
...
- Use `c++filt` to decode the mangled names returned by `std::type_info::name`
- The `typeid` operator ignores top-level `const`
...
- tells the compiler to deduce the type of a variable from its initializer;
...
- tells the compiler to deduce the type of a variable from an expression **without evaluating** that expression;
...
[exercise2_41_1_20.cpp](./exercise2_41_1_20.cpp)

[exercise2_41_1_21.cpp](./exercise2_41_1_21.cpp)

[exercise2_41_1_22.cpp](./exercise2_41_1_22.cpp)

[exercise2_41_1_23.cpp](./exercise2_41_1_23.cpp)

---
exercise2_41_1_24
```sh
$ g++ exercise2_41_1_23.cpp -o exercise2_41_1_23
$ ./exercise2_41_1_23 < data/book_sales
...
---
[exercise2_41_1_25.cpp](./exercise2_41_1_25.cpp)

```sh
$ g++ exercise2_41_1_25.cpp -o exercise2_41_1_25
$ ./exercise2_41_1_25 < data/book_sales
...
[exercise2_42_1_20.cpp](./exercise2_42_1_20.cpp)

[exercise2_42_1_21.cpp](./exercise2_42_1_21.cpp)

[exercise2_42_1_22.cpp](./exercise2_42_1_22.cpp)

[exercise2_42_1_23.cpp](./exercise2_42_1_23.cpp)

---
exercise2_42_1_24
```sh
$ g++ exercise2_42_1_23.cpp -o exercise2_42_1_23
$ ./exercise2_42_1_23 < data/book_sales
1 transaction(s) for 0-201-70353-X
1 transaction(s) for 0-201-82470-1
4 transaction(s) for 0-201-88954-4
2 transaction(s) for 0-399-82477-1
...
---
[exercise2_42_1_25.cpp](./exercise2_42_1_25.cpp)

```sh
$ g++ exercise2_42_1_25.cpp -o exercise2_42_1_25
$ ./exercise2_42_1_25 < data/book_sales
0-201-70353-X 4 99.96 24.99
0-201-82470-1 4 181.56 45.39
0-201-88954-4 16 198 12.375
0-399-82477-1 5 226.95 45.39
